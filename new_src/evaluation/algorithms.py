...
from evaluation.utilities.load_modules import find_module
from evaluation.operators.operator_template import NullMutation
...
class MOSolver(ABC):
    ...
    def load_operator(self, operator_type: str, operator_name: str, **kwargs: dict):
        ...
        if operator_type == "mutation" and operator_name == "NullMutation":
            ...
            # Load operator
            module_name = f"evaluation.operators.{operator_type}"
