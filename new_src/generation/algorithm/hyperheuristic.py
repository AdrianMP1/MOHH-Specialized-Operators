...
from generation.saver import PopulationSaver, MyLogger

from generation.problem.instance import Instance
from generation.algorithm.multiobjective import MOSolver
from generation.representation.population import Population
from generation.representation.population import Individual

# Auxiliar functions
from generation.utilities.print_utils import update_lines
from generation.utilities.load_modules import find_module
from generation.utilities.algorithm.MO import compute_nadir_point
from generation.utilities.algorithm.MO import compute_hypervolume
...
class HyperHeuristic():
    ...
    def load_operator(self, operator_type: str, operator_name: str, **kwargs: dict):
        ...
        module_name = f"generation.operators.{operator_type}"
...
#
    ...
    def run(self):
        ...
        # Reset singletons
        population_saver.reset_instance()
        logger_object.reset_instance()